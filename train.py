...
#agent_b1.load_model("save_model/best_each_episode/all/Trained_b1_20201115-193049_200.pth")
agent_b2 = Agent(state_size = state_size, action_size = action_size_defender, behavior_name = behavior_name_blue, index_player= 1)
#agent_b2.load_model("save_model/best_each_episode/all/Trained_b2_20201115-193049_200.pth")
agent_p1 = Agent(state_size = state_size, action_size = action_size_striker, behavior_name = behavior_name_pink, index_player= 0)
#agent_p1.load_model(path_model="paper_save_model/one_team/last_episode/version4/p1_episode_1000.pth", path_target="paper_save_model/one_team/last_episode/version4/target_p1_episode_1000.pth")
agent_p2 = Agent(state_size = state_size, action_size = action_size_defender, behavior_name = behavior_name_pink, index_player= 1)
#agent_p2.load_model(path_model="paper_save_model/one_team/last_episode/version4/p2_episode_1000.pth", path_target= "paper_save_model/one_team/last_episode/version4/target_p2_episode_1000.pth")
...
for i_episode in range(1, num_episodes + 1):
    ...
    if average_scores[0] > striker_solved_score and average_scores[1] > defender_solved_score:
        ...
        nn_p1_filename = 'p1_mod'#"paper_save_model/one_team/above_standard/Trained_p1_" + timestr + "_" + str(i_episode) + ".pth"
        nn_p2_filename = 'p2_mod'#"paper_save_model/one_team/above_standard/Trained_p2_" + timestr + "_" + str(i_episode) + ".pth"
        torch.save(agent_p1.network.state_dict(), nn_p1_filename)
        torch.save(agent_p2.network.state_dict(), nn_p2_filename)

    if i_episode % 50 == 0:
        timestr = time.strftime("%Y%m%d-%H%M%S")
        nn_last_p1_filename = 'p1_act_last' #new_last_episode_dir + "/p1_episode_" + str(i_episode) + ".pth"
        nn_last_target_p1_filename = "p1_target_last"#new_last_episode_dir + "/target_p1_episode_" + str(i_episode) + ".pth"

        nn_last_p2_filename = "p2_act_lat"#new_last_episode_dir + "/p2_episode_" + str(i_episode) + ".pth"
        nn_last_target_p2_filename = "p2_target_last"#new_last_episode_dir + "/target_p2_episode_" + str(i_episode) + ".pth"
